(define (problem p05-hamburguesa)
    ...
    (:init
        ...
        (pertenece armario-lechugas zona-1)
        (pertenece armario-tomates zona-1)
        (pertenece armario-panes zona-1)
        (pertenece armario-carnes zona-1)
        ...
        (vacio plato-2)
        (sobre plato-3 encimera-zona2-5)
        (ocupada encimera-zona2-5)
        (= (ingredientes plato-3) 0)
        (vacio plato-3)
        (sobre plato-4 encimera-zona2-6)
        (ocupada encimera-zona2-6)
        (= (ingredientes plato-4) 0)
        (vacio plato-4)
        (sobre plato-5 encimera-zona2-7)
        (ocupada encimera-zona2-7)
        (= (ingredientes plato-5) 0)
        (vacio plato-5)
    )
    (:goal (and
